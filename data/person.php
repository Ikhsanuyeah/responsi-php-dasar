...
class Person{
    ...
    {
        if (is_null($nama)) {
            echo "Hi, my nama is $this->nama<br>" . PHP_EOL;
        } else {
            echo "Hi $nama, my nama is $this->nama<br>" . PHP_EOL;
        }
    }

    // buat const author
    const AUTHOR = "Sistem Informasi B 22<br>";
    ...
    function __destruct()
    {
        echo "Object person $this->nama is destroyed<br>" . PHP_EOL;
    }
}
